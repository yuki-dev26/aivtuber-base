...
_active_comments: Optional[YouTubeComments] = None
...
def stop_aivtuber() -> None:
    global _active_comments
    if _active_comments is not None:
        _active_comments.terminate()


def run_aivtuber(stop_event: Optional[threading.Event] = None) -> None:
    global _active_comments
